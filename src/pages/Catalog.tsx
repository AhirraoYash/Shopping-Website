      ...
      {filteredProducts.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
          {filteredProducts.map((product) => (
            <div key={product.id} className="bg-white rounded-[16px] overflow-hidden shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)] border border-slate-100 flex flex-col transition-transform hover:-translate-y-1 hover:shadow-md duration-300">
              {product.imageUrl ? (
